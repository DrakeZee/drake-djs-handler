...
client.on("messageCreate", async (message) => {
	...
	const nocmd_embed = new MessageEmbed()
	...
	if (command.toggleOff) {
		const toggleoff_embed = new MessageEmbed()
			.setTitle(
		...
		const userperms_embed = new MessageEmbed()
		...
		const botperms_embed = new MessageEmbed()
		...
		if (!developerID.includes(message.author.id)) {
			const developersOnly_embed = new MessageEmbed()
